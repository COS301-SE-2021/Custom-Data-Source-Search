...
Please Note: Quality Gate is failing becuase they are not correctly detecting that some of our features will only be available on servers hosted **on your users's own machines.**

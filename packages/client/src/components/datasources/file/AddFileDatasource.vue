        ...
        filters: [
          {
            ...
            extensions: ['ts','js','java','dart','php','py','cpp','vue','html','css','yml','json','xml','c','go','pl','swift','scala','r','m','h','ino','matlab','rs','kt','groovy','s','asm','jl','cobol','scm','vbs','hs','hack','ada','lua','lisp','sh','clj','d','lgo','pdf','rtf','md','txt','odt','docx']
          }],
